...
void BlockMemoryManager::allocate_proc_mem(PCB &p)
{
...
//释放内存，传入参数pcb
void BlockMemoryManager::deallocate_proc_mem(PCB &p)
{
...
int main()
{
  ...
  bmm.print_list();
  bmm.allocate_proc_mem(a);
  bmm.allocate_proc_mem(b);
  bmm.allocate_proc_mem(c);
  bmm.print_list();
  bmm.deallocate_proc_mem(b);
  bmm.allocate_proc_mem(d);
  bmm.print_list();
  bmm.deallocate_proc_mem(a);
  bmm.allocate_proc_mem(b);
  bmm.print_list();
  bmm.deallocate_proc_mem(d);
  bmm.print_list();
  bmm.deallocate_proc_mem(b);
  bmm.print_list();
  bmm.deallocate_proc_mem(c);
  bmm.print_list();
  return 0;
}
